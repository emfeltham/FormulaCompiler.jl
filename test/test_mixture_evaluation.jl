# Comprehensive Test Suite for Categorical Mixture Evaluation Primitives
# Tests the core compilation and execution of categorical mixtures
...
@testset "Categorical Mixtures - Evaluation Primitives" begin
    ...
    @testset "Memory Usage and Scalability" begin
        ...
        @testset "Large Dataset Memory Usage" begin
            ...
            small_data = (
                x = randn(100),
                group = fill(mixture, 100)
            )

            # Large dataset
            large_data = (
                x = randn(10000),
                group = fill(mixture, 10000)
            )
