...
"""
Updated compile_formula that generates code for @generated functions.
"""
function compile_formula(model)
    println("=== Compiling Formula with Option 2: Recursive → @generated ===")
    
    rhs = fixed_effects_form(model).rhs
    
    # Step 1: Build recursive evaluator tree (handles all cases)
    ...
    # Step 2: Generate code strings from evaluator tree
    ...
    # Step 4: Return compiled formula that uses @generated function
