# marginal_effects_automatic_diff.jl
...
"""
    marginal_effects_eta!(G, Gβ_tensor, de::ADEvaluator, β, rows) -> (G, Gβ_tensor)
...
- **Speed**: Efficient batch processing with single beta setup
